...
from config import DISTANCE, PATH_IMAGES, PATH_INDEX, get_dataset_columns, NEIGHBORS_NUMBER, SEARCH_K
...
def query_annoy_index(annoy_index, query_vector, nearest_neighbors, chronometer: Chronometer):
    ...
    result = annoy_index.get_nns_by_vector(query_vector, nearest_neighbors, search_k=SEARCH_K) # Tuned parameter: search_k=number
...
def main():
    ...
    annoy_result_id = query_annoy_index(annoy_index, MOCKED_QUERY_VECTOR, NEIGHBORS_NUMBER, chronometer)
